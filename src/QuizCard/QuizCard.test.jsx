...
describe("QuizCard", () =>{
  ...
  beforeEach(() => {
    ...
    it('Should call the changeCurrent word function and incrememt score to be called when the correct button is clicked',() =>{
      ...
      render(<QuizCard incrementScore ={incrementScore} decrementScore = {decrementScore} favoriteWords = {[{shortdef:['testWord1']},{shortdef:['testWord2']},{shortdef:['testWord3'],{shortdef:['testWord2']},{shortdef:['testWord4']}]} currentWord = {currentWord}/>)
